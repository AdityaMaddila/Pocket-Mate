...
import { Calendar, CalendarSearchIcon } from "lucide-react";
    ...
    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="space-y-2 mt-4">
        ...
        <div className="space-y-2">
            ...
            <Popover>
                <PopoverTrigger asChild><Button variant="outline" className="w-full pl-3 text-left font-normal">{date ? format(date,"PPP"): <span>Pick a date</span>}  
                <CalendarSearchIcon className="ml-auto h-4 w-4 o[pacity-50"/>
