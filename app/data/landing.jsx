import {
  ...
  export const howItWorksData = [
    {
      icon: <CreditCard className="h-8 w-8 text-white-600" />,
      title: "1. Create Your Account",
      description:
        "Get started in minutes with our simple and secure sign-up process",
    },
    {
      icon: <BarChart3 className="h-8 w-8 text-white-600" />,
      title: "2. Track Your Spending",
      description:
        "Automatically categorize and track your transactions in real-time",
    },
    {
      icon: <PieChart className="h-8 w-8 text-white-600" />,
  ...
  const gradientTextStyle = {
    background: "linear-gradient(to right, #4F46E5, #9333EA)", // Example gradient
